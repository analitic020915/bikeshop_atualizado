...
public class CadastroProduto extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        pnForm.setBounds(10, 0, 364, 104);
        lbNome = new javax.swing.JLabel();
        lbNome.setBounds(35, 26, 56, 14);
        lbPrecoCompra = new javax.swing.JLabel();
        lbPrecoCompra.setBounds(10, 51, 103, 14);
        lbPrecoVenda = new javax.swing.JLabel();
        lbPrecoVenda.setBounds(12, 71, 101, 14);
        ftfNome = new javax.swing.JFormattedTextField();
        ftfNome.setBounds(123, 23, 206, 20);
        ftfPrecoCompra = new javax.swing.JFormattedTextField();
        ftfPrecoCompra.setBounds(123, 47, 86, 20);
        ftfPrecoVenda = new javax.swing.JFormattedTextField();
        ftfPrecoVenda.setBounds(123, 71, 86, 20);
        spGrade = new javax.swing.JScrollPane();
        spGrade.setBounds(10, 104, 364, 251);
        ...
        pnForm.add(lbPrecoCompra);

        lbPrecoVenda.setText("Preço de venda:");
        pnForm.add(lbPrecoVenda);
