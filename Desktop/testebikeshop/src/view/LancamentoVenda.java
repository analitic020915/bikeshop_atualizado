...
import DAO.VendaDAO;
import controller.ItemVendaTableModel;
import controller.VendaTableModel;
import model.Cliente;
import model.ItemVenda;
import model.Produto;
import model.Venda;
import enumclass.Situacao;
...
public class LancamentoVenda extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        pnBarraFerramentas.setBackground(Color.WHITE);
        ...
        tpConteudo.setBackground(Color.WHITE);
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Lançamentos de Vendas");
        ...
        btNovo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/img/novo.png")));
        btNovo.setText("Novo");
        btNovo.setFocusable(false);
        btNovo.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        btNovo.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        btNovo.setMargin(new java.awt.Insets(2, 8, 2, 8));
        btNovo.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/img/novo-foco.png"))); 
        ...
        btSalvar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/img/salvar.png"))); 
        ...
        btSalvar.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/img/salvar-foco.png"))); 
        ...
        btFinalizar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/img/finalizar.png"))); 
        ...
        btFinalizar.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/img/finalizar-foco.png"))); 
        ...
        btExcluir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/img/excluir.png"))); 
        ...
        btExcluir.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/img/excluir-foco.png"))); 
        ...
        btCancelar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/img/cancelar.png"))); 
        ...
        btCancelar.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/img/cancelar-foco.png"))); 
        ...
        btCliente.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/img/buscar.png"))); 
        ...
        btCliente.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/img/buscar-foco.png"))); 
        ...
        pnForm.add(ftfDataVenda, gridBagConstraints_1);
        ...
        btProduto.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/img/buscar.png"))); 
        ...
        btProduto.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/img/buscar-foco.png")));
        ...
        btAdicionarItem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/img/novo.png"))); 
        btAdicionarItem.setToolTipText("Adicionar item");
        btAdicionarItem.setPreferredSize(new java.awt.Dimension(35, 30));
        btAdicionarItem.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/img/novo-foco.png"))); 
        ...
        btRemoverItem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/img/excluir.png"))); 
        btRemoverItem.setToolTipText("Remover item");
        btRemoverItem.setPreferredSize(new java.awt.Dimension(35, 30));
        btRemoverItem.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/img/excluir-foco.png"))); 
    ...
    private void btAdicionarItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAdicionarItemActionPerformed
        if (validarFormularioItens()) {
            ...
            //if(iv.getQuantidade() == 10) {
            	//JOptionPane.showMessageDialog(null, "Repor estoque!");
